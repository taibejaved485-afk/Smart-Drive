    ...
    <div className="min-h-screen bg-white">
      ...
      >
        <div className="py-24 px-4">
          ...
          <p className="mb-10 text-lg max-w-xl mx-auto text-gray-700">Ready to start your driving journey? Enroll in one of our courses today and become a safe, confident driver with <span className="font-bold">Training Driving School</span>.</p>
