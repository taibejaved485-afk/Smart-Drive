        ...
        <div className="grid lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 border-t border-gray-100 md:divide-x divide-gray-100 mb-6">
              {/* Feature 1 */}
              <div className="py-6 pr-0 md:pr-6 border-b border-gray-100">
              ...
              {/* Feature 2 */}
              <div className="py-6 md:pl-6 border-b border-gray-100">
                <div className="flex gap-4">
                  <CheckCircle2 className="w-6 h-6 text-red-600 flex-shrink-0 mt-1" />
                  <div>
              ...
              {/* Feature 3 */}
              <div className="py-6 pr-0 md:pr-6 border-b md:border-b-0 border-gray-100">
                <div className="flex gap-4">
                  <CheckCircle2 className="w-6 h-6 text-red-600 flex-shrink-0 mt-1" />
                  <div>
