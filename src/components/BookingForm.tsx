    ...
    <section id="contact" className="py-20 bg-navy-900 text-white">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form className="bg-white p-8 rounded-2xl shadow-xl text-navy-900 grid gap-6">
          <input type="text" name="name" autoComplete="name" placeholder="Full Name" className="w-full p-4 border border-gray-200 rounded-lg" />
          <input type="tel" name="tel" autoComplete="tel" placeholder="Phone Number" className="w-full p-4 border border-gray-200 rounded-lg" />
