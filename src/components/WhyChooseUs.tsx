    ...
    <section className="py-24 bg-white text-gray-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          >
            Choosing the right driving school is the first step toward becoming a skilled and responsible driver. At Training Driving School, we don't just teach you how to drive—we prepare you for real-world road challenges with confidence and competence.
          </motion.p>
        </div>
