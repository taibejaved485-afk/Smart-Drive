...
const reviews = [
  { name: 'Abdul Majeed', text: 'Well done sir g bhot hi acha work kr raha ga apka training driving school Faisalabad', rating: 5, avatar: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&q=80&w=120&h=120' },
  ...
  { name: 'Malik Orangzaib', text: 'Mashallah Allah AP ko sir apke staff or apke training driving school ko hameshs salamat rakhe', rating: 5, avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&q=80&w=120&h=120' },
  ...
  return (
    <section className="py-24 bg-gray-50 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-4xl font-bold text-center mb-16 text-gray-950">What Our Students Say</h2>
