  ...
  return (
    <section className="bg-gray-950 py-12 relative overflow-hidden border-t border-white/5">
      ...
      <div className="w-full max-w-7xl mx-auto px-6 relative z-10">
        <div className="bg-gradient-to-r from-red-950/40 via-gray-905/90 to-slate-900/40 border border-white/10 rounded-3xl p-8 sm:p-12 flex flex-col lg:flex-row items-center justify-between gap-8 shadow-2xl relative overflow-hidden">
          ...
          <div className="space-y-4 max-w-2xl text-center lg:text-left relative z-10">
            ...
            <h3 className="text-2xl sm:text-3xl lg:text-4xl font-black text-white tracking-tight font-sans leading-tight">
